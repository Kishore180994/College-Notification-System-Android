...
public class HODList extends Activity implements View.OnClickListener{
	
	TextView tvExam, tvAdmin, tvCSE, tvCSEN, tvECE, tvEIE, tvEEE, tvMBA, tvBSH, tvMECH, tvAllContacts, tvCivil;
	...
	private void navigateToContacts(String strSelectedBranch) {
		try {
			Intent intent = new Intent(HODList.this, ContactsList.class);
	...
	private void openLogOutDialog() {
		try {
			AlertDialog.Builder alertDialog = new AlertDialog.Builder(HODList.this);
			alertDialog.setMessage("Are you sure you want to logout");
			alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {

				@Override
				public void onClick(DialogInterface dialog, int which) {
					Intent intent = new Intent(HODList.this, Main.class);
