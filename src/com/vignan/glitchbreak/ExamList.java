...
public class ExamList extends Activity implements View.OnClickListener{
	...
	TextView tvHOD, tvExam, tvAdmin, tvAllContacts;
	...
	private void navigateToContacts(String strSelectedBranch) {
		try {
			Intent intent = new Intent(ExamList.this, ContactsList.class);
	...
	private void openLogOutDialog() {
		try {
			AlertDialog.Builder alertDialog = new AlertDialog.Builder(ExamList.this);
			alertDialog.setMessage("Are you sure you want to logout");
			alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {

				@Override
				public void onClick(DialogInterface dialog, int which) {
					Intent intent = new Intent(ExamList.this, Main.class);
